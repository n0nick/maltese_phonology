...
Since the type and count of the suffixes are the only visible difference between the UR of (1d) and (1e), we must conclude that the alternations in examples (b-d) revolve 
