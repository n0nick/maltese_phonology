...
\begin{tabularx}{\textwidth}{|l||l X|l X|l X|}
	...
	CCCVC &
	\textipa{\underline{sfrOn}.d5} & 'to collapse' \cite{mifsudloan} &
	\multicolumn{2}{c|}{---} &
	\multicolumn{2}{c|}{---} \\\hline
...
Let's consider the following subject prefixes in Maltese\cite{1974}:
...
It is immediately visible that while the stem's original form is $CVCVC$, it is not preserved in forms (b) and (c) of the above examples.
