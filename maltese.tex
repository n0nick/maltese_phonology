...
Examples (1d) and (1e) contradict any attempt to explain the vowel alternations by structural constraints alone. While the URs of both examples offer the same possible product \textipa{[h5.t5f.n5]}, it is only preserved in (1e), with a 1-sg subject suffix and a 1-pp object suffix. A subject suffix alone does not help (1d) to avoid the vowel deletion we witnessed in all other examples.
\\
