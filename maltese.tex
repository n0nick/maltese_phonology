...
Let's now analyse the \textsl{+\O} inflection in examples (1a) and (2a), where vowel deletion does not occur.
\\

\paragraph*{(12)} {\mbox{}}
\begin{tabular}{|rrl||c|c|c|c|}\hline\multicolumn{3}{|c||}{/\textipa{h5t5f+t}/} & {\sc MaxStress} & {\sc Dep} & {\sc *V[-stress]} & {\sc *CC} \\ \hline\hline a. &  & \textipa{"h5t5ft} &  &  & *! & *\\ \hline b. &  & \textipa{ht5ft} & *! &  &  & *\\ \hline c. &  & \textipa{"h5t5fEt} &  & *! & * & \\ \hline d. &  & \textipa{"ht5fEt} &  & *! &  & \\ \hline e. & $\rightarrow$ & \textipa{"ht5ft} &  &  &  & *\\ \hline\end{tabular}
