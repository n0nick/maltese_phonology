...
One would be tempted to suggest a straightforward explanation to these facts, such as for example a constraint on syllabification that would favour $CVC$ syllables over other forms.
\\

This kind of analysis, however, is bound to be challenged; firstly, as we can clearly see in section 1.2.2, the language allows for many other syllable forms quite freely, so such preference for $CVC$ would seem like a very low priority constraint.
\\
