...
\paragraph*{(8)} {\sc *ComplexCoda}
\\

Combining constraints (7) and (8) we can explain both \textsl{+t} and \textsl{+\O} inflected forms of the verb quite easily.
\\

\begin{tabular}{|rrl||c|c|c|}\hline\multicolumn{3}{|c||}{/\textipa{"h5t5f+Et}/} & {\sc *SOMETHING} & {\sc *V[-stress]} & {\sc *CC} \\ \hline\hline a. &  & \textipa{"h5t5fEt} &  & **! & \\ \hline b. &  & \textipa{"ht5fEt} & *! & * & \\ \hline c. & $\rightarrow$ & \textipa{"h5tfEt} &  & * & \\ \hline d. &  & \textipa{"h5t5ft} &  & * & *!\\ \hline\end{tabular}
