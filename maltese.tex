...
Let's consider the Maltese suffixes for the 2\super{nd} person singular subjects; the empty suffix \textipa{+\O} for 'he' and the suffix \textsl{\textipa{+5t}} for 'she' \cite{brame1974}.
...
Another challenge with such analysis arises when reviewing the data for the \textsl{+t} suffix for the 1\super{st} person singular subject:
