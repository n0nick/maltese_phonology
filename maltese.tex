...
\footnotetext[1]{Unless otherwise marked, examples taken from \citeN{borg1997}}
...
This kind of analysis, however, is bound to be challenged; firstly, we can clearly see in, for example, \textsl{\textipa{bI-\underline{PzI:}.PEs}}, \textsl{\textipa{m5h.\underline{mU}.\t{dZ}i:n}} and other examples from chart (3), occurrences of an open syllable in a word medial position, so it seems the said rule would not account for these examples.
\\
